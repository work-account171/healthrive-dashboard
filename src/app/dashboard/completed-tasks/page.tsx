    ...
    <>
          ...
          <>
            <div className="flex flex-col gap-4">
              <div className="flex gap-4">
                ...
                <p className="bg-green-200 rounded-xl text-green-500 px-2.5 py-1.5">Completed</p>
                <p
              ...
              <button
                ...
                className="cursor-pointer bg-primary px-4 py-2 rounded-xl w-fit text-white flex gap-2"
              >
                <Undo2 /> Undo Complete
              </button>
              ...
              <button
                ...
                className="cursor-pointer bg-red-600 hover:bg-red-500 px-4 py-2 rounded-xl w-fit text-white flex gap-2"
              >
                <Trash /> Delete Task
              </button>
            </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedTask.categories.map((category) => (
                    <div key={category} className="bg-blue-100 px-2 py-1 text-blue-600 rounded-full">
                      {category}
                    </div>
                  ))}
                </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedTask.services.map((service) => (
                    <div key={service} className="bg-blue-100 px-2 py-1 text-blue-600 rounded-full">
                      {service}
                    </div>
                  ))}
                </div>
      ...
      <div className="flex flex-col justify-start items-start gap-6">
        <div className="flex flex-col gap-4 justify-start items-start">
          ...
          <p className="text-[16px]">Good work! These are the tasks you completed so far.</p>
        </div>
              ...
              {loading ? (
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {completedTasks.map((task, index) => (
                    <tr key={index} className="hover:bg-gray-50 text-[16px] transition duration-150">
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-2.5 rounded-xl font-medium bg-green-400 text-white">
                          Completed
                        </span>
                      </td>
                      <td className="px-6 py-4">
