          ...
          <div className="flex flex-col justify-center items-center gap-10">
            ...
            >
              <div className="flex flex-col gap-2 justify-center items-start w-full">
                ...
                />
                                <Link href="/forget-password" className="text-sm text-primary text-right w-full hover:underline" onClick={()=>router.back()}>Back to Login</Link>

              </div>
              
              <button type="submit" className="w-full bg-primary py-4 px-5 rounded-xl text-white text-[16px] hover:bg-transparent hover:text-primary border-pimary border">Send Reset Link</button>
            </form>
          </div>
        </div>
      </section>
