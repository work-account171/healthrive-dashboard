      ...
      <div className="rounded-xl py-6 px-6 flex flex-col gap-5 border my-2 border-gray-200 bg-white shadow-sm">
        ...
        <div className="flex justify-between items-start gap-4 w-full flex-wrap">
          ...
          <select
            ...
            className="py-3 px-4 border border-gray-200 text-gray-700 bg-white rounded-xl w-48 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer text-[16px]"
          >
